...
public class Pokerito {
    ...
    public static String randomCard() {
        int cardNumber = new Random().nextInt(13) + 1;
        switch(cardNumber) {
            case 1: return "   _____\n"+
                           "  |A _  |\n"+
                           "  | ( ) |\n"+
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        scan.nextLine();
        System.out.println("Great! It's like Poker, but a lot simpler! Here's how it works...");
        System.out.println("\n>> • There are two players, you and the computer." +
                         "\n>> • The dealer will give each player one card." +
                         "\n>> • Then, the dealer will draw five cards (the river)" +
                         "\n>> • The player with the most river matches wins!" +
        ...
        */
         ...
         *      ...
         */
        System.out.println("Now, the dealer will draw five cards. Press enter to continue and press enter to advance " +
                           "each card draw.");
        for (int i = 1; i < 6; i++) {
            scan.nextLine();
            ...
            if (riverCard.equals(userCard)) {
                yourMatches++;
            } else if (riverCard.equals(compCard)) {
                computerMatches++;
            }
        ...
        if (yourMatches > computerMatches) {
            ...
            System.out.println("Matches are equal - everyone wins!");
        }
